...
<div id="addnews">
    ...
    <asp:RegularExpressionValidator ControlToValidate="txtTitle" ID="RegularExpressionValidator1" runat="server" ErrorMessage="RegularExpressionValidator" ></asp:RegularExpressionValidator>
    <br />
    Phụ đề:<br />
